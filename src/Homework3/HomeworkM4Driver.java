...
public class HomeworkM4Driver {
	...
	public static void main(String[] args) {
		...
		System.out.println("The length of the bag array is 160" + resizableBag.getLength());
		resizableBag.trimToSize();
		System.out.println("The length of the bag array is 100" + resizableBag.getLength());
